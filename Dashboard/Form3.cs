...
namespace Dashboard
{
    ...
    public partial class Form3 : Form
    {
        ...
        #region Variables
        public const string
            DownloadURL = "https://whis99.com/launch/phasmofreedll/WhiskyHackFree.dll",
            PaidURL = "https://whis99.com/UnityDependencies/q/WhiskyHackPremium.dll",
            ReleasesAPI = "https://whis99.com/updates/freeupdate.txt",
            PaidAPI = "https://whis99.com/updates/paidupdate.txt",
            MelonURL = "https://whis99.com/launch/phasmofreedll/melon.zip";
        ...
        private string path
        {
            get
            {
                ...
                {
                    _path = WhisLauncher.FileUtilities.FindGameLocation();
                }
                ...
                if (string.IsNullOrEmpty(_pluginFile))
                {
                    ...
                    try
                    {
                        _pluginFile = Directory.
                            GetFiles(folder).
                            Where(f => AssemblyName.GetAssemblyName(f).Equals("WhiskyHackFree")).
                            First();
                    }
                    catch (Exception)
                    {
                        Directory.CreateDirectory(folder);
                        _pluginFile = Path.Combine(folder, "WhiskyHackFree.dll");
                    }
            ...
            get
            {
                ...
                if (string.IsNullOrEmpty(_pluginFile2))
                {
                    ...
                    try
                    {
                        _pluginFile = Directory.
                            GetFiles(folder).
                            Where(f => AssemblyName.GetAssemblyName(f).Equals("WhiskyHackPremium")).
                            First();
                    }
                    catch (Exception)
                    {
                        Directory.CreateDirectory(folder);
                        _pluginFile2 = Path.Combine(folder, "WhiskyHackPremium.dll");
                    }
    ...
    zipFile = Path.Combine(tempFolder + "melon.zip");
        ...
        public static string AuthorizationChecker = "https://whis99.com/x/phasmo3.txt";
