...
namespace Dashboard
{
    ...
    public partial class Form4 : Form
    {
        ...
        #region Variables
        public const string
            DownloadURL = "https://whis99.com/crabbb/downloads/CrabHack_WhiskyFree.dll",
            PaidURL = "https://whis99.com/crabbb/downloads/CrabHack_WhiskyPaid.dll",
            ReleasesAPI = "https://whis99.com/crabbb/downloads/updates/freeupdate.txt",
            PaidAPI = "https://whis99.com/crabbb/downloads/updates/paidupdate.txt",
            MelonURL = "https://whis99.com/crabbb/downloads/melon.zip";
        ...
        private string path
        {
            get
            {
                ...
                {
                    _path = WhisLauncher.FileUtilities.FindGameLocation2();
                }
                ...
                if (string.IsNullOrEmpty(_pluginFile))
                {
                    ...
                    try
                    {
                        _pluginFile = Directory.
                            GetFiles(folder).
                            Where(f => AssemblyName.GetAssemblyName(f).Equals("CrabHack_WhiskyFree")).
                            First();
                    }
                    catch (Exception)
                    {
                        Directory.CreateDirectory(folder);
                        _pluginFile = Path.Combine(folder, "CrabHack_WhiskyFree.dll");
                    }
            ...
            get
            {
                ...
                if (string.IsNullOrEmpty(_pluginFile2))
                {
                    ...
                    try
                    {
                        _pluginFile = Directory.
                            GetFiles(folder).
                            Where(f => AssemblyName.GetAssemblyName(f).Equals("CrabHack_WhiskyPaid")).
                            First();
                    }
                    catch (Exception)
                    {
                        Directory.CreateDirectory(folder);
                        _pluginFile2 = Path.Combine(folder, "CrabHack_WhiskyPaid.dll");
                    }
    ...
    zipFile = Path.Combine(tempFolder + "melon.zip");
        ...
        private void client2_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            System.Diagnostics.Process.Start("steam://rungameid/1782210");
        }
        ...
        private void pictureBox3_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    hileindir2();
                    System.Diagnostics.Process.Start("steam://rungameid/739630");
